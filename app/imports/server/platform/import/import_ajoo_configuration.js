...
ImportAjooConfiguration.prototype = {
  ...
  init: async function() {
	...
	// 	console.log("importPaletteButtons", palette_buttons)


	// 	console.log("self.obj_type_map ", this.obj_type_map)
	...
	// 			console.log("elem_type_id ", elem_type_id)


	// 			console.log("zz", self.obj_type_map[elem_type_id])
