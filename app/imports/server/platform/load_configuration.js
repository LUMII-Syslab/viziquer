...
async function load_configurator(user_id) {
  ...
  diagram_type_id = await DiagramTypes.insertAsync(diagram_type_obj);
...
async function build_box_type(tool_id, version_id, diagram_type_id, super_box_id) {
  ...
  // await CompartmentTypes.insertAsync(compart_type_obj, {removeEmptyStrings: false});
...
async function build_swimlane(tool_id, version_id, diagram_type_id) {
  ...
  var box_id = ElementTypes.insertAsync(box_type_obj);
