...
Meteor.methods({
  ...
  importOntology: async function (list, ontology) {
    ...
    let diagram_type = await DiagramTypes.findOneAsync({ name: "Ontology", toolId: tool_id, });
    if (!diagram_type) {
    ...
    let diagram_object = {
      name: `Ontology diagram - ${ontology.Schema}`,
    ...
    // Box part
    let box_type = await ElementTypes.findOneAsync({ type: "Box", diagramTypeId: diagram_type._id });
    if (!box_type) {
    ...
    await ontology.SH.forEachAsync(async function (item, key) {
    ...
    // Gen part
    let gen_type = await ElementTypes.findOneAsync({ name: "Gen", diagramTypeId: diagram_type._id });
    if (!gen_type) {
    ...
    await ontology.Gen.forEachAsync(async function (item, key) {
      let object = {
        diagramId: new_diagram_id,
        type: "Line",
        points: [0, 20, 20, 20],
    ...
    // Line3 part
    let line3_type = await ElementTypes.findOneAsync({ name: "Line", diagramTypeId: diagram_type._id });
    if (!line3_type) {
    ...
    await ontology.Line3.forEachAsync(async function (item, key) {
      let object = {
        diagramId: new_diagram_id,
        type: "Line",
        points: [0, 10, 10, 10],
  ...
  importOntologyNew: async function (list, ontology) {
    ...
    let diagram_object = {
      name: `DataSchema - ${ontology.Schema}`,
      diagramTypeId: diagram_type._id,
      style: diagram_type.style,
      createdAt: new Date(),
      createdBy: user_id,
    ...
    await ontology.Class.forEachAsync(async function (item, key) {
    ...
    await ontology.Generalization.forEachAsync(async function (item, key) {
      let object = {
        diagramId: new_diagram_id,
        type: "Line",
        points: [0, 20, 20, 20],
    ...
    await ontology.ObjectProperty.forEachAsync(async function (item, key) {
      let object = {
        diagramId: new_diagram_id,
        type: "Line",
        points: [0, 10, 10, 10],
