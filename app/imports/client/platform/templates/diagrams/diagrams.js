...
Template.diagramsToolbar.events({
  ...
  'click #download-project': async function (e) {
    Dialog.destroyTooltip(e);
    ...
    let resp = await Utilities.callMeteorMethodAsync("getProjectJson", list);
...
Template.diagramsViewButton.events({
  ...
  'click .view-switch': async function (e) {
    e.preventDefault();
    ...
    await Utilities.callMeteorMethodAsync("updateUserVersionSettings", list);
  },
});
...
Template.diagramsSortButton.events({
  ...
  "click .sort-by-item": async function (e) {
    e.preventDefault();
...
Template.diagramsGroupsButton.events({
  ...
  "click .select-group-item": async function (e) {
    e.preventDefault();
...
Template.defaultDiagramsView.events({
  ...
  "click .duplicate-diagram": async function (e) {
    ...
    await Utilities.callMeteorMethodAsync("duplicateDiagram", list);
...
Template.treeDiagramsView.events({
  ...
  'click .treeNodeButton': async function (e) {
...
Template.ontologySettings.events({
  ...
  'click #ok-ontology-settings': async function () {
    ...
    await Utilities.callMeteorMethodAsync("updateProjectOntology", list);
  ...
  "click #test-endpoint": async function () {
    ...
    let res = await Utilities.callMeteorMethodAsync("testProjectEndPoint", list);
...
Template.renameDiagramForm.events({
  ...
  "click #rename-diagram-form-ok": async function () {
