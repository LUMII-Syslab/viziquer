...
Template.dialogTabContent.events({
  ...
  "click .detach-file": async function (e) {
    ...
    await Utilities.callMeteorMethodAsync("detachFileFromElement", list);
  ...
  "click .file-link": async function (e) {
    ...
    let url = await Utilities.callMeteorMethodAsync("getFileUrl", list);
...
Template.attachFiles.events({
  ...
  "click .attach-file": async function (e) {
    ...
    await Utilities.callMeteorMethodAsync("attachFileToElement", list);
  },
...
Template.uploadFileFormInDiagram.events({
  ...
  "click #upload-file-form-ok": function (e) {
    ...
    uploader.send(file, async function (error, file_url) {
      ...
      if (error) {
        ...
        //inserting a file
        const file_id = await Utilities.callMeteorMethodAsync("insertFile", list);
        ...
        await Utilities.callMeteorMethodAsync("attachFileToElement", list2);
