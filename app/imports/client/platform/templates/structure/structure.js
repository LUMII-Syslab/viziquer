...
Template.structureTemplate.events({
  ...
  'click .remove-project-obj': async function (e) {
    e.preventDefault();
    //e.stopPropagation();
    ...
    await Utilities.callMeteorMethodAsync("removeProject", list);
  ...
  'click .leave-project': async function (e) {
    e.preventDefault();
    //e.stopPropagation();
    ...
    await Utilities.callMeteorMethodAsync("leaveProject", list);
...
Template.editProjectModal.events({
  ...
  "click #project-edited": async function (e) {
    e.preventDefault();
