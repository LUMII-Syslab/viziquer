...
async function update_diagram_style(attr_name, attr_value) {
  ...
  if (target_diagram_type) {
    ...
    await Utilities.callMeteorMethodAsync("updateDiagramTypeStyle", list);
  }

  //updating the diagram
  else {
    var list = {
      id: Session.get("activeDiagram"),
      attrName: attr_name,
      attrValue: attr_value,
    ...
    await Utilities.callMeteorMethodAsync("updateDiagramStyle", list);
  }
}
