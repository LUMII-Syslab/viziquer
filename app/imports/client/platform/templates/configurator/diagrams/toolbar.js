...
Template.readModeToolbarButtons.events({
  ...
  'click #add-read-mode-toolbar-button': function (e) {
    ...
    var toolbar_button = {
      id: generate_id(), icon: "fa-plus", name: "item",
...
async function add_toolbar_item(attr_name, toolbar_button) {
  var list = { id: Session.get("targetDiagramType"), attrName: attr_name, push: toolbar_button };
  await Utilities.callMeteorMethodAsync("addToolbarItem", list);
}

async function remove_toolbar_item(attr_name, toolbar_button) {
  var list = { id: Session.get("targetDiagramType"), attrName: attr_name, pull: toolbar_button };
  await Utilities.callMeteorMethodAsync("removeToolbarItem", list);
}

async function update_toolbar_item(attr_name, attr_value) {
