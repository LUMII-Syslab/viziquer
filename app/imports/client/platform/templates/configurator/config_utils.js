...
var Configurator = {
  ...
  updateCompartmentType: async function (list) {
    ...
    await Utilities.callMeteorMethodAsync("updateCompartmentType", list);
  },
  ...
  updateObjectTypeObj: async function (attr_name, attr_value) {
    ...
    if (Session.get("activeElement")) {
      ...
      if (elem_type) {
        ...
        await Utilities.callMeteorMethodAsync("updateElementType", list);
      }
    }

    else {
      _.extend(list, { id: Session.get("targetDiagramType") });
      await Utilities.callMeteorMethodAsync("updateDiagramType", list);
    }
  },

  updateElementFromInput: async function (e, function_name) {
    ...
    await Utilities.callMeteorMethodAsync(function_name, list);
  ...
  deleteKeystrokeOrItem: async function (e, procedure_name, collection) {
    ...
    if (collection["collection"] == "ElementTypes") {
      ...
      if (elem_type) {
        ...
        await Utilities.callMeteorMethodAsync("deleteKeystrokeOrItem", list);
      }
    }
    ...
    //diagram types	
      ...
      var list = {
        id: Session.get("targetDiagramType"),
        array: collection["array"],
        data: table_data,
      };
      await Utilities.callMeteorMethodAsync("deleteDiagramTypeKeystrokeOrItem", list);
    }
  },
  ...
  addKeystrokeOrItem: async function (e, procedure_name, collection) {
    var data = {};
    ...
    if (collection["collection"] === "ElementTypes") {
      ...
      if (elem_type) {
        ...
        await Utilities.callMeteorMethodAsync("addKeystrokeOrItem", list);
      }
    }
    ...
    //diagram types
      ...
      await Utilities.callMeteorMethodAsync("addDiagramTypeKeystrokeOrItem", list);
    }
  },

  updateKeystrokeOrItem: async function (e, procedure_name, collection) {
    ...
    if (collection["collection"] == "ElementTypes") {
      ...
      if (elem_type) {
        ...
        await Utilities.callMeteorMethodAsync("updateKeystrokeOrItem", list);
      }
    }
    ...
    //diagram types	
      ...
      await Utilities.callMeteorMethodAsync("updateDiagramTypeKeystrokeOrItem", list);
    }
  },
...
async function update_element_style_object(attr_name, attr_value, style_type) {

  var list = {
    attrName: style_type + "." + attr_name,
    attrValue: attr_value,
  };
  ...
  if (Session.get("activeElement") && target_elem_type) {
    ...
    await Utilities.callMeteorMethodAsync("updateElementTypeStyle", list);
  }
  ...
  //updating the presentation element
    ...
    await Utilities.callMeteorMethodAsync("updateElementStyle", list);
  }
}
