...
async function update_compartment_style(list) {
  await Utilities.callMeteorMethodAsync("updateCompartmentTypeStyle", list);
}
...
async function update_compartment_type_style_field(attr_name, attr_value) {
