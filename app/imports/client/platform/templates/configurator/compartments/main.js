...
Template.compartmentMain.events({
  ...
  'click #addCompartment': async function (e) {
    ...
    let id = await Utilities.callMeteorMethodAsync("insertCompartmentType", args);
    Session.set("compartmentTargetTypeId", id);
    Session.set("activeCompartmentStyleIndex", 0);

  },

  'click #deleteCompartment': async function (e) {
    var list = { id: Session.get("compartmentTargetTypeId") };
    await Utilities.callMeteorMethodAsync("removeCompartmentType", list);
