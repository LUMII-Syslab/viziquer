...
Interpreter.methods({
  ...
  createDiagram: async function (diagram_name, diagram_type_id) {
    ...
    if (res != false) {
      ...
      let id = await Utilities.callMeteorMethodAsync("insertDiagram", list);
  ...
  DeleteDiagramObject: async function (list) {
  ...
  AddTargetDiagram: async function () {
    ...
    if (elem_type) {
      ...
      await Utilities.callMeteorMethodAsync("addTargetDiagram", list);
    }
  },
