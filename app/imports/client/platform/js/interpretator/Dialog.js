...
//Updating functions
async function insert_compartment(list) {
  await Utilities.callMeteorMethodAsync("insertCompartment", list);
}

async function update_compartment(list) {
  await Utilities.callMeteorMethodAsync("updateCompartment", list);
}
