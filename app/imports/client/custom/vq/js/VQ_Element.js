...
async function Create_VQ_Element(func, location, isLink, source, target) {
  ...
  if (isLink) {
    ...
    var new_line = {
      ...
      style: {
        startShapeStyle: elem_style["startShapeStyle"],
    ...
    let elem_id = await Utilities.callMeteorMethodAsync("insertElement", new_line);
    ...
    let elem_id = await Utilities.callMeteorMethodAsync("insertElement", new_box);
    var vq_obj = new VQ_Element(elem_id);
    if (func) { func(vq_obj) };
...
VQ_Element.prototype = {
  ...
  setLinkNameVisibility: async function (visible, input, value) {
    if (this.isLink()) {
      var elem_type_id = this.obj["elementTypeId"];
  ...
  setCompartmentVisibility: async function (compartmentName, visible, input, value) {
    var elem_type_id = this.obj["elementTypeId"];
  ...
  setCompartmentValue: async function (comp_name, input, value, insertMode) {
  ...
  setCustomStyle: function (style_attr_list) {
    ...
    _.forEach(style_attr_list, async function (a) {
  ...
  setClassStyle: function (style) {
    ...
    var element_id = this._id();
    var diagram_id = this.getDiagram_id();
    _.each(elemData, async function (a) {
      a["elementId"] = element_id
      a["diagramId"] = diagram_id
      a["projectId"] = Session.get("activeProject");
      a["versionId"] = Session.get("versionId");
