...
import { dataShapes } from '/imports/client/custom/vq/js/DataShapes';
  ...
  async function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c76 = async function(Var) {return {VariableName:makeVar(Var)}},
        peg$c77 = async function() {return },
        peg$c78 = "|",
        peg$c79 = { type: "literal", value: "|", description: "\"|\"" },
        peg$c80 = async function() {return {Alternative:"|"}},
        peg$c81 = async function() {return {PathSymbol :"/"}},
        peg$c82 = async function(PathEltOrInverse) {return await pathOrReference(PathEltOrInverse)},
        peg$c83 = "",
        peg$c84 = async function() {await getAssociations(await location(), 90, 4);},
        ...
        peg$c91 = async function() {await addContinuation(await location(), "a", 50, 4);},
        ...
        peg$c96 = async function() {await addContinuation(await location(), "/", 50, 4);},
        ...
        peg$c99 = async function() {await addContinuation(await location(), "<", 50, 4);},
        peg$c100 = async function() {await addContinuation(await location(), ">", 50, 4);},
        peg$c101 = async function() {await addContinuation(await location(), ":", 50, 4);},
        peg$c102 = async function() {await addContinuation(await location(), " ", 10, 4);},
        peg$c103 = async function() {await addContinuation(await location(), "[", 50, 4);},
        peg$c104 = async function() {await addContinuation(await location(), "]", 50, 4);},
        peg$c105 = async function() {await error(await returnContinuation()); return;},
