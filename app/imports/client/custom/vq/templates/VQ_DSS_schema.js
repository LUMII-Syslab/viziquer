...
function setPropSliderInfo() {
	...
	console.log('ppppppp', propSliderIntValues)
	//console.log('ppppppp', propSliderIntValuesTemp)
	console.log('ppppppp', propSliderTextValues)
	console.log('ppppppp', propPositions)
