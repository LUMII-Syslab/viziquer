...
Template.toolbarButtons.events({
  ...
  "click #remove-toolbar-button": function (e) {
    ...
    var src = $(
      ".toolbar-button[index=" + Session.get("activeToolbarButton") + "]",
    );
    ...
    //read mode
      ...
      toolbar_button.isInEditableVersion = Boolean(
        src.attr("isInEditableVersion"),
      );
...
Template.readModeToolbarButtons.events({
  "click #add-read-mode-toolbar-button": function (e) {
    ...
    if (diagram_type && diagram_type.readModeToolbar)
      Session.set(
        "activeReadModeToolbarButton",
        diagram_type.readModeToolbar.length,
      );
  ...
  "click #remove-read-mode-toolbar-button": function (e) {
    var src = $(
      ".toolbar-button[index=" +
        Session.get("activeReadModeToolbarButton") +
        "]",
    );
