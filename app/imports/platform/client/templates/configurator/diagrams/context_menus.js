...
Template.editCollectionContextMenu.helpers({
  menu: function () {
    return {
      ...
      dynamicContextMenu: {
        name: "dynamicCollectionContextMenu",
...
Template.readCollectionContextMenu.helpers({
  menu: function () {
    return {
      ...
      dynamicContextMenu: {
        name: "dynamicReadModeCollectionContextMenu",
        value: get_diagram_type_extension_point(
...
Template.editNoCollectionContextMenu.helpers({
  menu: function () {
    return {
      ...
      dynamicContextMenu: {
        name: "dynamicNoCollectionContextMenu",
        value: get_diagram_type_extension_point(
...
Template.readNoCollectionContextMenu.helpers({
  menu: function () {
    return {
      ...
      items: Configurator.getKeystrokesOrItems(
        "readModeNoCollectionContextMenu",
      ),
      dynamicContextMenu: {
        name: "dynamicReadModeNoCollectionContextMenu",
        value: get_diagram_type_extension_point(
