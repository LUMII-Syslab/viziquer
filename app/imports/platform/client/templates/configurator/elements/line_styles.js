...
Template.lineStyle.helpers({
  is_ajoo_editor: function () {
    ...
    if (is_ajoo_editor(editor_type)) return true;
    else return;
  },
});
...
Template.lineObjectZoomChartStyle.helpers({
  line_style: function () {
    ...
    elem_style.fromDecorations = [
      { option: "", value: "--No style--" },
      { option: "circle", value: "circle" },
      { option: "arrow", value: "arrow" },
    ];

    Configurator.selectItem(
      elem_style.fromDecorations,
      elem_style.fromDecoration,
    );

    elem_style.toDecorations = [
      { option: "", value: "--No style--" },
      { option: "circle", value: "circle" },
      { option: "arrow", value: "arrow" },
    ];
