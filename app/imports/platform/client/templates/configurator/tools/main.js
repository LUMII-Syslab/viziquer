...
import { Tools, Projects } from "../../../../../db/platform/collections.js";
...
Template.renameTool.events({
  "click #update-tool-name": function (e) {
    ...
    var list = {
      ...
      set: { name: tool_name, isDeprecated: is_deprecetad },
    };
  ...
  "click #loadModel": function (e) {
    _.each($("#model-upload")[0].files, function (file_in) {
      ...
      reader.onload = function () {
        var project_ids = _.map(
          $(".load-model-checkbox:checked"),
          function (check_box) {
...
Template.settings.helpers({
  panel_settings: function () {
    return [
      ...
      {
        options: get_tool_setting("documents"),
        id: "documents",
        name: "Documents",
      },
      ...
      {
        options: get_tool_setting("analytics"),
        id: "analytics",
        name: "Analytics",
      },
      ...
      {
        options: get_tool_setting("training"),
        id: "training",
        name: "Training",
      },
    ];
