  ...
  TestDynamicContextMenu: function () {
    ...
    return [
...

      {
        item: "DDD",
        subMenu: [
          { item: "submenu11", procedure: "submenu11" },
    ...
    return DiagramLogs.find(
      ...
      if (diagram_log.action === "added") {
        ...
        var elem_type = ElementTypes.findOne({
          _id: action_data.elementTypeId,
        });
        if (elem_type) name = elem_type.name;
        ...
        text =
          "Updated attribute:<br>" +
          "old value: " +
          action_data.oldValue +
          "<br>" +
          "new value: " +
          action_data.newValue;
      }
...
export { build_element_names_array };
