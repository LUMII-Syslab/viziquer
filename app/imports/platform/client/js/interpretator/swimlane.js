...
Interpreter.methods({
  SwimlaneContextMenu: function () {
    return [
      ...
      {
        item: "Remove Column on Right",
        procedure: "RemoveSwimlaneColumnRight",
      },
...
function add_swimlane_row_or_column(
  line_index,
  index,
  lines_group1,
  lines_group2,
) {
  add_remove_swimlane_row_or_column(
    line_index,
    index,
    lines_group1,
    lines_group2,
...
function delete_swimlane_row_or_column(
  line_index,
  index,
  lines_group1,
  lines_group2,
...
function add_remove_swimlane_row_or_column(
  line_index,
  index,
  lines_group1,
  lines_group2,
  ...
  if (remove_or_add === "add") {
    swimlane.add_swimlane_row_or_column(
      line_index,
      index,
      lines_group1,
      lines_group2,
    ...
    res = swimlane.remove_swimlane_row_or_column(
      line_index,
      index,
      lines_group1,
      lines_group2,
