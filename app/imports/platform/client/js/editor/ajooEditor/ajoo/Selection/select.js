...
import UnSelection from "./unselect.js";
...
Selection.prototype = {
  ...
  buildGroups: function () {
    ...
    return {
      InLinesGroup: editor.findChild(drag_layer, "InLinesGroup"),
  ...
  align: function (ha, va) {
    ...
    if (ha === -1) {
      m = _.min(
        _.map(_.values(sel), function (arect) {
  ...
  adjustSpacing: function (ha, va) {
    ...
    if (ha === 1) {
      ...
      sel = _.sortBy(sel, function (b) {
        return b.getElementPosition().x;
      });
