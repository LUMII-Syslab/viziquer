...
import {
  SVGObject,
  LineSVGObject,
} from "../../Lines/routing/svg_collisions.js";
...
SVGShape.prototype.computeNewPath = function (
  shape_path,
  scale_x,
  scale_y,
  x,
  ...
  var res = shape_path.match(/[a-z]|\-?\d*([.]\d*)?/gi);
  var is_x = true;
...
var TwitterBird = function (editor) {
  ...
  var path =
    "M512,97.209c-18.838,8.354-39.082,14.001-60.33,16.54c21.687-13,38.343-33.585,46.187-58.115" +
...
ComputedDataPinMultiple.prototype.compartmentArea =
  ComputedDataPinSingle.prototype.compartmentArea;
...
PortIn.prototype.compartmentArea = function () {
  ...
  if (port_box_size.x < 0) {
    //port is on the left of the parent box
  ...
  if (port_box_size.x >= 0) {
    //port is on the right of the parent box
    res["x1"] = 0 + 4;
...
DeclaredRequiredMultiplePin.prototype.compartmentArea =
  ComputedDataPinSingle.prototype.compartmentArea;
...
DeclaredProvidedMultiplePin.prototype.compartmentArea =
  ComputedDataPinSingle.prototype.compartmentArea;
...
ThreeTriangles.prototype.compartmentArea =
  ComputedDataPinSingle.prototype.compartmentArea;
...
ThreeTrianglesAndRectangle.prototype.compartmentArea =
  ComputedDataPinSingle.prototype.compartmentArea;
...
ThreeFilledTrianglesAndRectangle.prototype.constructor =
  ThreeFilledTrianglesAndRectangle;

ThreeFilledTrianglesAndRectangle.prototype.compartmentArea =
  ComputedDataPinSingle.prototype.compartmentArea;
...
RectangleAndThreeTriangles.prototype.compartmentArea =
  ComputedDataPinSingle.prototype.compartmentArea;
...
RectangleAndThreeFilledTriangles.prototype.constructor =
  RectangleAndThreeFilledTriangles;

RectangleAndThreeFilledTriangles.prototype.compartmentArea =
  ComputedDataPinSingle.prototype.compartmentArea;
...
var Shoes = function (editor) {
  ...
  var path1 =
    "M18.626,50.494c-2.461,0-4.859,0.253-7.206,0.652c-0.163,4.019-0.183,9.874,1.743,12.148    c2.712,3.203,8.699,3.203,11.106-0.444c2.387-3.62,0.804-8.826,0.136-11.924C22.508,50.674,20.591,50.494,18.626,50.494z";
  var path2 =
  ...
  var path3 =
    "M47.016,37.062c-2.01,0-3.972,0.188-5.906,0.452c-0.718,3.144-1.971,7.934,0.263,11.32    c2.406,3.647,8.395,3.647,11.106,0.445c1.832-2.165,1.902-7.582,1.766-11.565C51.891,37.318,49.484,37.062,47.016,37.062z";
  var path4 =
    "M45.46,0.002c-6.205-0.22-9.052,14.307-7.592,18.321c0.717,1.969,2.455,5.842,3.283,9.563    c0.687,3.076,0.545,6.098,0.319,7.77c1.82-0.226,3.661-0.381,5.545-0.381c2.44,0,4.815,0.249,7.151,0.628    c-0.048-1.009-0.094-1.832-0.094-2.324c0-3.212,1.588-8.719,2.192-11.388C57.942,14.748,51.663,0.221,45.46,0.002z";

  var shapes_data = [
    { name: "A", path: path1, originalWidth: 65.644, originalHeight: 65.645 },

    { name: "B", path: path2, originalWidth: 65.644, originalHeight: 65.645 },

    { name: "C", path: path3, originalWidth: 65.644, originalHeight: 65.645 },

    { name: "D", path: path4, originalWidth: 65.644, originalHeight: 65.645 },
  ];
...
export {
  ...
  DeclaredRequiredMultiplePin,
  ThreeTriangles,
  ThreeTrianglesAndRectangle,
  ThreeFilledTrianglesAndRectangle,
  RectangleAndThreeTriangles,
  RectangleAndThreeFilledTriangles,
};
