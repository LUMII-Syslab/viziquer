...
BPMNTerminate.prototype.createShape = function (prop_list) {
  ...
  outer_circle.allowed = { stroke: true, strokeWidth: true, dash: true };
  ...
  inner_circle.denied = { stroke: true, strokeWidth: true, dash: true };
...
BPMNMultiple.prototype.createShape = function (prop_list) {
  ...
  inner_star.denied = { stroke: true, strokeWidth: true, dash: true };
...
BPMNDiamondPlus.prototype.createShape = function (prop_list) {
  ...
  outer_shape.allowed = { stroke: true, strokeWidth: true, dash: true };
