...
SwimlaneCompartments.prototype = {
  ...
  get_cell_key: function (swimlane) {
    ...
    for (var key in cells) {
      ...
      if (
        cell_rect["x1"] <= mouse_x &&
        mouse_x <= cell_rect["x2"] &&
        cell_rect["y1"] <= mouse_y &&
        mouse_y <= cell_rect["y2"]
      ) {
