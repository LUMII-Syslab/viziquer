    ...
    switch (elem_style.fillPriority) {
      ...
      case "linear-gradient":
        if (elem_style.shape === "Square") {
          ...
          res.fillLinearGradientStartPointX =
            -1.75 * offset_x +
            box_width * elem_style.fillLinearGradientStartPointX;
          res.fillLinearGradientStartPointY =
            -0.75 * offset_y +
            box_height * elem_style.fillLinearGradientStartPointY;
          res.fillLinearGradientEndPointX =
            -0.25 * offset_x +
            box_width * elem_style.fillLinearGradientEndPointX;
          res.fillLinearGradientEndPointY =
            -1.25 * offset_y +
            box_height * elem_style.fillLinearGradientEndPointY;
        } else if (elem_style.shape === "Hexagon") {
          res.fillLinearGradientStartPointX =
            box_height * elem_style.fillLinearGradientStartPointY - offset_y;
          res.fillLinearGradientStartPointY =
            box_width * elem_style.fillLinearGradientStartPointX - offset_x;
          res.fillLinearGradientEndPointX =
            box_height * elem_style.fillLinearGradientEndPointY - offset_y;
          res.fillLinearGradientEndPointY =
            box_width * elem_style.fillLinearGradientEndPointX - offset_x;
        } else {
          res.fillLinearGradientStartPointX =
            box_width * elem_style.fillLinearGradientStartPointX - offset_x;
          res.fillLinearGradientStartPointY =
        ...
        res.fillLinearGradientColorStops =
          elem_style.fillLinearGradientColorStops;

        break;

      case "radial-gradient":
        res.fillRadialGradientStartPointX =
          box_width * elem_style.fillRadialGradientStartPointX - offset_x;
        res.fillRadialGradientStartPointY =
          box_height * elem_style.fillRadialGradientStartPointY - offset_y;
        res.fillRadialGradientEndPointX =
          box_width * elem_style.fillRadialGradientEndPointX - offset_x;
        res.fillRadialGradientEndPointY =
          box_height * elem_style.fillRadialGradientEndPointY - offset_y;
        res.fillRadialGradientStartRadius =
          box_width * elem_style.fillRadialGradientStartRadius;
        res.fillRadialGradientEndRadius =
          box_width * elem_style.fillRadialGradientEndRadius;
        res.fillRadialGradientColorStops =
          elem_style.fillRadialGradientColorStops;
...
Box.prototype = {
  ...
  updateSize: function (new_width, new_height) {
    ...
    //updating size
    var new_size = box.computeShapeSize(
      resized_size.width,
      resized_size.height,
    );
  ...
  updateStyle: function (style_obj) {
    ...
    var style;
    if (style_obj) style = style_obj.elementStyle;
    ...
    if (style.shape && box.name !== style.shape) {
      ...
      if (box.resizers) box.resizers.remove();
  ...
  collectLinkedLinesByName: function (
    in_or_out,
    lines,
    selected,
    linked_ports,
  ...
  computeConnectionPointPositions: function () {
    ...
    //top middle point
    var point1_obj = vertical_line_svg.get_closest_point_from_intersections(
      [x, -inf],
      v_inter_points,
    );
    if (point1_obj.point) {
    ...
    //bottom middle point
    var point2_obj = vertical_line_svg.get_closest_point_from_intersections(
      [x, inf],
      v_inter_points,
    );
    if (point2_obj.point) {
    ...
    //left middle point
    var point3_obj = vertical_line_svg.get_closest_point_from_intersections(
      [-inf, y],
      h_inter_points,
    );
    if (point3_obj.point) {
    ...
    //right middle point
    var point4_obj = vertical_line_svg.get_closest_point_from_intersections(
      [inf, y],
      h_inter_points,
    );
    if (point4_obj.point) {
