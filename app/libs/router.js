...
FlowRouter.route(
  "/project/:projectId/diagram/:_id/type/:diagramTypeId/version/:versionId/:editMode?",
  {
    ...
    action(params, queryParams) {
      ...
      this.render("mainLayout", {
        main: "diagramTemplate",
        ribbon: "diagramRibbon",
      });
...
FlowRouter.route(
  "/public/project/:projectId/diagram/:_id/type/:diagramTypeId/version/:versionId",
  {
    name: "public-diagram",
    waitOn() {
      // return import('/imports/platform/client/templates/signup/signup.js');
...
FlowRouter.route("/configurator", {
  ...
  waitOn() {
    return import(
      "/imports/platform/client/templates/configurator/configurator.js"
    );
  },
...
FlowRouter.route(
  "/tool/:toolId/version/:versionId/diagram/:_id/diagramType/:diagramTypeId",
  {
    ...
    action(params, queryParams) {
      ...
      this.render("mainLayout", {
        main: "configuratorDiagramTemplate",
        ribbon: "diagramRibbon",
      });
...
FlowRouter.route("/tool/:_id/:versionId?", {
  ...
  subscriptions: function (params, queryParams) {
    this.register(
      "ToolVersions_Diagrams_DiagramTypes",
      Meteor.subscribe("ToolVersions_Diagrams_DiagramTypes", {
        toolId: params["_id"],
        versionId: params["versionId"],
      }),
    );
  ...
  action(params, queryParams) {
    ...
    var version_id = params.versionId;
    if (version_id) Session.set("toolVersionId", version_id);
    else Session.set("toolVersionId", reset_variable());
