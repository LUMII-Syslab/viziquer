...
vq_grammar_completion_parser = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c258 = function(PathAlternative) {return {PathAlternative:PathAlternative}},
        peg$c259 = function(PathSequence) {return {PathSequence:PathSequence}},
        peg$c260 = function(PathEltOrInverse) {return {PathEltOrInverse:PathEltOrInverse}},
        peg$c261 = function(PathElt) {return {inv:"", PathElt:PathElt}},
        peg$c262 = "^",
        peg$c263 = { type: "literal", value: "^", description: "\"^\"" },
        peg$c264 = function(PathElt) {return {inv:"^", PathElt:PathElt}},
        peg$c265 = "inv",
        peg$c266 = { type: "literal", value: "inv", description: "\"inv\"" },
        peg$c267 = function(PathPrimary, PathMod) {return {PathPrimary:PathPrimary, PathMod:PathMod}},
        peg$c268 = "a",
        peg$c269 = { type: "literal", value: "a", description: "\"a\"" },
        peg$c270 = function(PathNegatedPropertySet) {return {PathNegatedPropertySet:PathNegatedPropertySet}},
        peg$c271 = function(PathOneInPropertySet) {return {PathOneInPropertySet:PathOneInPropertySet}},
        peg$c272 = function(PathNegatedPropertySetBracketted) {return {PathNegatedPropertySetBracketted:PathNegatedPropertySetBracketted}},
        peg$c273 = function(iriOra) {return {inv:"", iriOra:iriOra}},
        peg$c274 = function(iriOra) {return {inv:"^", iriOra:iriOra}},
        peg$c275 = function(PrefixedName) {return {PrefixedName:PrefixedName}},
        peg$c276 = function(Prefix) {return makeVar(Prefix)},
        peg$c277 = function(PNAME_NS, LName) {return {var:{name:makeVar(LName),type:resolveType(makeVar(PNAME_NS)+makeVar(LName)), kind:resolveKind(makeVar(PNAME_NS)+makeVar(LName))}, Prefix:PNAME_NS}},
        peg$c278 = function(LName) {return {var:{name:makeVar(LName),type:resolveType(makeVar(LName)), kind:resolveKind(makeVar(LName))}}},
        peg$c279 = function() {return {Alternative:"|"}},
        peg$c280 = function() {return {PathSymbol :"/"}},
        peg$c281 = function(PathEltOrInverse) {return pathOrReference(PathEltOrInverse)},
        peg$c282 = function(Reference) {return referenceNames(Reference)},
        peg$c283 = function(Chars_String) {return makeVar(Chars_String)},
        peg$c284 = { type: "literal", value: "INV", description: "\"INV\"" },
        peg$c285 = function(INV, LName, Substring, FunctionBETWEEN, FunctionLike) {return { var:{INV:INV, name:makeVar(LName), type:resolveTypeFromSchemaForAttributeAndLink(makeVar(LName))}, Substring:makeVar(Substring), FunctionBETWEEN:FunctionBETWEEN, FunctionLike:FunctionLike}},
        ...
        peg$c297 = /^[\-_.:, \^$\/]/,
        peg$c298 = { type: "class", value: "[-_.:, ^$/]", description: "[-_.:, ^$/]" },
        peg$c299 = "like",
        peg$c300 = { type: "literal", value: "LIKE", description: "\"LIKE\"" },
        peg$c301 = "%",
        ...
        peg$c314 = function() {if(options.type=="attribute") addContinuation(location(), "(select this)", 10, false, 4); else addContinuation(location(), "", 1, false, 4);},
        peg$c315 = function() {if(options.type!="attribute") addContinuation(location(), "(this)", 85, false, 4); else addContinuation(location(), "", 1, false, 4);},
        ...
        peg$c335 = function() {if(options.type=="attribute") addContinuation(location(), "COUNT_DISTINCT", 35, false, 4); else addContinuation(location(), "", 1, false, 4);},
        peg$c336 = function() {addContinuation(location(), "DISTINCT", 90, false, 4);},
        peg$c337 = function() {if(options.type=="attribute") addContinuation(location(), "COUNT", 35, false, 4); else addContinuation(location(), "", 1, false, 4);},
        peg$c338 = function() {if(options.type=="attribute")addContinuation(location(), "SUM", 35, false, 4);else addContinuation(location(), "", 1, false, 4);},
        peg$c339 = function() {if(options.type=="attribute")addContinuation(location(), "MIN", 35, false, 4);else addContinuation(location(), "", 1, false, 4);},
        peg$c340 = function() {if(options.type=="attribute")addContinuation(location(), "MAX", 35, false, 4);else addContinuation(location(), "", 1, false, 4);},
        peg$c341 = function() {if(options.type=="attribute")addContinuation(location(), "AVG", 35, false, 4);else addContinuation(location(), "", 1, false, 4);},
        peg$c342 = function() {if(options.type=="attribute")addContinuation(location(), "SAMPLE", 35, false, 4);else addContinuation(location(), "", 1, false, 4);},
        peg$c343 = function() {if(options.type=="attribute")addContinuation(location(), "GROUP_CONCAT", 35, false, 4);else addContinuation(location(), "", 1, false, 4);},
        peg$c344 = function() {addContinuation(location(), "SEPARATOR", 10, false, 4);},
