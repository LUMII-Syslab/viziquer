			...
			if(order["exp"].startsWith("?")){
				...
				if(typeof fieldNames[orderNameRep] !== 'undefined'){
					...
					if(typeof order["parsed_exp"] === 'undefined'){
						...
						var result = parse_attrib(order["exp"], [], rootClass_id, order["parsed_exp"], null, idTable[rootClass_id], idTable[rootClass_id], [], [], 0, emptyPrefix, symbolTable, false, [], idTable, referenceTable, classMembership, null, knownPrefixes);
...
function generateSPARQLWHEREInfo2(sparqlTable, ws, fil, lin, referenceTable, SPARQL_interval, parameterTable){
	...
	//class triple
	if(typeof sparqlTable["classTriple"] !== 'undefined') links.push(sparqlTable["classTriple"]);
