	...
	// + vajadziga tabula ar prefiksiem xsd : <vvvvvv.xsd> ... shortForm = fullForm
	// tabula ar parametriem
	  ...
	  {function makeVar(o) {
		...
		function pathOrReference(o) {
			...
			if(o["Path"][0] != null && o["Path"][1] == null && classInstences.indexOf(o["Path"][0]["path"]) > -1) {
				return {Reference: o["Path"][0]["path"], PrimaryExpression : o["PrimaryExpression"], ReferenceToClass: o["ReferenceToClass"], ValueScope:o["ValueScope"], FunctionBETWEEN : o["ValueScope"], FunctionLike : o["FunctionLike"]}
				//                 referenceta klase 
			}
			return o;
      }}
			...
			IRIREF = IRIREF:("<" ([A-Za-z] / "_" / ":" / "." / "#" / "/" / [0-9])* ">") {return {IRIREF:IRIREF}}
			...
			invPath1 = ("INV(" Chars_String:Chars_String ")") {return "^" + makeVar(Chars_String)} // atributs vai associacija
			invPath2 = ("^" Chars_String:Chars_String) {return "^" + makeVar(Chars_String)} // atributs vai associacija
			invPath3 = (Chars_String:Chars_String) {return makeVar(Chars_String)} // atributs vai associacija
			Chars_String = (([A-Za-z] / "_") ([A-Za-z] / "_" / [0-9])*)
			LName = (LName: Chars_String Substring:Substring ReferenceToClass: ReferenceToClass? ValueScope: ValueScope? space FunctionBETWEEN: BetweenExpression? FunctionLike: LikeExpression?) {return {var:makeVar(LName), Substring:makeVar(Substring), ReferenceToClass: ReferenceToClass, ValueScope: ValueScope, FunctionBETWEEN:FunctionBETWEEN, FunctionLike:FunctionLike}}
			...
			LName2 = (LName: Chars_String Substring:Substring) {return {var:makeVar(LName), Substring:makeVar(Substring)}}
																		//atributs vai associacija
			Relation = "=" / "!=" /  "<=" / ">=" /"<" / ">" / "<>"
			space = ((" ")*) {return }
