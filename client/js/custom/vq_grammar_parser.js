...
vq_grammar_parser = (function() {
  ...
  async function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c386 = async function(ref, PropertyReference, Prefix, LName, Substring, FunctionBETWEEN, FunctionLike) {return {var:{name:makeVar(Prefix)+makeVar(LName), ref:ref, type:await resolveType(makeVar(Prefix)+makeVar(LName)), kind:await resolveKind(makeVar(Prefix)+makeVar(LName)), PropertyReference:PropertyReference},Prefix:Prefix, Name:makeVar(LName), Substring:makeVar(Substring), FunctionBETWEEN:FunctionBETWEEN, FunctionLike:FunctionLike}},
        ...
        peg$c445 = async function(ref, PNAME_NS, LName) {return {var:{name:makeVar(PNAME_NS)+makeVar(LName), ref:ref,type:await resolveType(makeVar(PNAME_NS)+makeVar(LName)), kind:await resolveKind(makeVar(PNAME_NS)+makeVar(LName))}, Prefix:PNAME_NS}},
        peg$c446 = async function(ref, LName) {return {var:{name:makeVar(LName),ref:ref, type:await resolveType(makeVar(LName)), kind:await resolveKind(makeVar(LName))}}},
        ...
        peg$c458 = async function(ref, PropertyReference, LName, PathMod, Substring, FunctionBETWEEN, FunctionLike) {return {var:{name:makeVar(LName), ref:ref, type:await resolveType(makeVar(LName)), kind:await resolveKind(makeVar(LName)), PathMod:PathMod, PropertyReference:PropertyReference},  Substring:makeVar(Substring), FunctionBETWEEN:FunctionBETWEEN, FunctionLike:FunctionLike}},
        peg$c459 = { type: "literal", value: "INV", description: "\"INV\"" },
        peg$c460 = async function(ref, PropertyReference, INV, LName, Substring, FunctionBETWEEN, FunctionLike) {return { var:{INV:INV, name:makeVar(LName), ref:ref, type:await resolveTypeFromSchemaForAttributeAndLink(makeVar(LName)), PropertyReference:PropertyReference}, Substring:makeVar(Substring), FunctionBETWEEN:FunctionBETWEEN, FunctionLike:FunctionLike}},
        peg$c461 = async function(ref, PropertyReference, INV, PNAME_NS, LName, Substring, FunctionBETWEEN, FunctionLike) {return { var:{INV:INV, name:makeVar(LName), ref:ref, type:await resolveTypeFromSchemaForAttributeAndLink(makeVar(PNAME_NS)+makeVar(LName)), PropertyReference:PropertyReference}, Substring:makeVar(Substring), FunctionBETWEEN:FunctionBETWEEN, FunctionLike:FunctionLike}},
        peg$c462 = async function(ref, PropertyReference, INV, LName, Substring, FunctionBETWEEN, FunctionLike) {return { var:{INV:"INV", name:makeVar(LName), ref:ref, type:await resolveTypeFromSchemaForAttributeAndLink(makeVar(LName)), PropertyReference:PropertyReference}, Substring:makeVar(Substring), FunctionBETWEEN:FunctionBETWEEN, FunctionLike:FunctionLike}},
        peg$c463 = async function(PropertyReference, LName) {return {var:{name:makeVar(LName), type:await resolveType(makeVar(LName)), kind:await resolveKind(makeVar(LName)), PropertyReference:PropertyReference}}},
        peg$c464 = "!=",
        ...
        peg$c476 = /^[\-_.:, \^$()!@#%&*+?|\/]/,
        peg$c477 = { type: "class", value: "[-_.:, ^$()!@#%&*+?|/]", description: "[-_.:, ^$()!@#%&*+?|/]" },
        peg$c478 = async function() {return "\\\\"},
        peg$c479 = async function(string) {return string.join("")},
        peg$c480 = "like",
        peg$c481 = { type: "literal", value: "LIKE", description: "\"LIKE\"" },
        peg$c482 = async function(string) {return string},
        peg$c483 = "~*",
        peg$c484 = { type: "literal", value: "~*", description: "\"~*\"" },
        peg$c485 = async function(string) {return {string: string, case: "i"}},
        peg$c486 = "~",
        peg$c487 = { type: "literal", value: "~", description: "\"~\"" },
        peg$c488 = async function(start, string, end) {return {string: makeVar(string), start:start, end:end}},
        peg$c489 = async function(string) {return {string: makeVar(string), start:"%", end:"%"}},
        peg$c490 = "between",
        peg$c491 = { type: "literal", value: "BETWEEN", description: "\"BETWEEN\"" },
        peg$c492 = async function(BetweenExpressionL, BetweenExpressionR) {return {BetweenExpressionL:BetweenExpressionL, BetweenExpressionR:BetweenExpressionR}},
